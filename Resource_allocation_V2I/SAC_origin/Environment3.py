...
"""Vehicle related."""
vehicle_number: Optional[int] = SAC_origin_train.n_veh
...
class Environ:
    ...
    def get_state(self):
        ...
        V2I_abs_lastslot=self.V2I_abs_timeslos[self.time_slots.now() - 1] if self.time_slots.now() != 0 else [0, 0, 0, 0, 0]
        # 方案2 车辆的v作为state的第二维
